...
def td3(env_fn, env_fn_test, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
    ...
    sil_replay_buffer = prioritized_buffer.PrioritizedReplayBuffer(size=replay_size, alpha=alpha)
    ...
    backup_sil = tf.stop_gradient(r_ph_sil + backup_discount_nstep*(1-d_ph_sil)*min_q_targ_sil)
...
if __name__ == '__main__':
    ...
    if args.delay > 1:
        ...
        env_name = args.env
    logdir = 'td3_sil_nstep_{}/seed_{}nstep_{}gamma_{}hid_{}l_{}alpha_{}beta_{}silweight_{}'.format(env_name, args.seed, args.nstep, args.gamma, args.hid, args.l,
